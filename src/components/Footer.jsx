...
const Footer = () => {
  return (
    <div className="relative flex flex-col bg-white shadow-lg rounded-3xl p-6 md:p-8 w-full text-white transition-all duration-300">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div className="name-tagline flex flex-col">
          <div className="name font-bold text-base md:text-lg text-gray-900 flex items-center gap-2">
            Surya Vashisth
            <img
      ...
      {/* Main Text Section */}
      <div className="footer-text text-gray-800 text-center mb-4 md:mb-6 text-sm md:text-base">
      ...
      <div className="flex justify-center mb-6">
        <ButtonConnect
          ...
          icon=""
          classes="px-4 py-2 text-sm md:text-base"
        />
      </div>

      {/* Centered Buttons for Navigation Links */}
      <div className="social-buttons flex justify-center space-x-2 md:space-x-4 mb-4">
        <ButtonFooter
          href="/"
          label="Home"
          icon="home"
          classes="px-3 md:px-4 py-1 md:py-2 text-sm md:text-base"
        />
        <ButtonFooter
          href="/Work"
          label="My Work"
