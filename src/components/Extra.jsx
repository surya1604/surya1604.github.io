...
const Extra = () => {
    const projects = [
      ...
      },
      {
        ...
        imgSrc:
          "https://res.cloudinary.com/dsbbvur7w/image/upload/f_auto,q_auto/v1/portfolio/more%20work/qqg1nfadz59hrmy9bb0q", // Replace with actual image URL
      ...
      },
      {
        ...
        imgSrc:
          "https://res.cloudinary.com/dsbbvur7w/image/upload/f_auto,q_auto/v1/portfolio/more%20work/jydnygfqfzvuijmeoajt", // Replace with actual image URL
        link: "https://github.com/surya1604",
      },
      {
        ...
        imgSrc:
          "https://res.cloudinary.com/dsbbvur7w/image/upload/f_auto,q_auto/v1/portfolio/more%20work/ljgh65ibbuyeyqu5yxx5", // Replace with actual image URL
      ...
      },
      {
        ...
        imgSrc:
          "https://upload.wikimedia.org/wikipedia/commons/5/5f/Coursera_logo_%282020%29.svg", // Replace with actual image URL
      ...
      },
      {
        ...
        subheading: "Certificate",
        imgSrc:
          "https://upload.wikimedia.org/wikipedia/commons/e/e3/Udemy_logo.svg", // Replace with actual image URL
    ...
    return (
      <div className=" text-white p-8">
        ...
        <div className="mt-20 mb-12">
          <h1 className="text-4xl font-bold">Extra Mile</h1>
        ...
        <div className="space-y-4 mb-12">
          {projects.map((project, index) => (
            <a
              ...
              className="flex items-center justify-between p-4 border border-gray-700 rounded-xl bg-gray-900 hover:bg-gray-800 transition"
            >
              {/* Left: Image */}
