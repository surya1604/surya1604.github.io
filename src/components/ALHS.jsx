                        ...
                        <div className="text-center  bg-gray-700 shadow-lg rounded-3xl p-2 max-w-4xl">
                            ...
                            <h6 className="text-sm font-medium tracking-wider uppercase text-gray-400">
                                ...
                                {" "}<strong className="text-blue-400">
                                    He'll be guiding us through this project as well! </strong> Madhur lovers to research for which he comes to the class at the earliest!  {" "}<strong className="text-blue-400">
